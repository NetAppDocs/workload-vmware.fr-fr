...
. Dans le menu VMware, sélectionnez *Évaluer et planifier* puis *Migration vers VMware Cloud on AWS*.
+
La page principale de VMware migration Advisor s'affiche.

. Sélectionnez *Planifier et créer VMC*.
. Sélectionnez *Commençons !*. Vous pouvez choisir de ne plus afficher cette page en cochant la case.
...
.Étapes
. Téléchargez et installez RVTools 4.4.2 ou une version supérieure dans le https://www.dell.com/en-us/shop/vmware/sl/rvtools["Site Web RVTools"^]
...
+
Consultez le chapitre sur les « paramètres de ligne de commande » dans le https://www.dell.com/en-us/shop/vmware/sl/rvtools["Documentation RVTools dans la section Ressources"^] pour plus de détails.
